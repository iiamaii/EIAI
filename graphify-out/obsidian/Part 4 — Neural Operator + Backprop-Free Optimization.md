...
## Connections
- [[4-Part Material Collection Plan (ws)]] - `has_part` [EXTRACTED]
- [[DalmHiratani-style Node Perturbation Can Effectively Train Multi-Layer Networks]] - `belongs_to_part` [EXTRACTED]
- [[EGGROLL Evolution Strategies at the Hyperscale (Sarkar et al.)]] - `belongs_to_part` [EXTRACTED]
- [[Hinton The Forward-Forward Algorithm — Two Forward Passes Replace Backprop]] - `belongs_to_part` [EXTRACTED]
